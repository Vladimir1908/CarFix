...
// ── ELIMINAT: const MECHANICS = [...] — mecanicii vin acum din API ──
...
export default function DashboardAdmin({ onLogout }: { onLogout: () => void }) {
  ...
  // ── Lista mecanici incarcata din API (pentru selectul din Programari) ───────
  const [mechanicsList, setMechanicsList] = useState<{ id: number; firstName: string; lastName: string }[]>([]);
              ...
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(170px, 1fr))", gap: 16, marginBottom: 32 }}>
                  {[
                    ...
                    // ── NOU: card mecanici activi ──
                    { label: "Mecanici activi", value: mechanicsList.length, color: "#f97316", icon: "🔩" },
                  ].map(card => (
                          ...
                          <div key={i} style={{ padding: "18px 20px", borderBottom: i < filtered.length - 1 ? "1px solid #f3f3f3" : "none" }}>
                            <div style={{ display: "flex", gap: 20, flexWrap: "wrap", alignItems: "flex-start" }}>
                              ...
                              <div style={{ flex: "1 1 160px" }}>
                                ...
                                {/* ── NOU: select populat din API in loc de MECHANICS hardcodat ── */}
